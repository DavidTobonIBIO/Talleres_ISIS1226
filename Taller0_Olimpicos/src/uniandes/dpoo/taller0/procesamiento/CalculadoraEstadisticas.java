...
public class CalculadoraEstadisticas
{
	...
	/**
	 * MODIFICACION:
	 * Busca el nombre del pais al cual pertence el atleta recibido por parametro.
	 * 
	 * @return nombre del pais al que pertenece el atleta
	 */	
	public String paisDeAtleta(String nombreAtleta)
	{
		String resultado = "El atleta no se encuentra";
